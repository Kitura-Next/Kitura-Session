...
<p align="center">
    <a href="https://kitura-next.github.io/Kitura-Session/index.html">
    <img src="https://img.shields.io/badge/apidoc-KituraSession-1FBCE4.svg?style=flat" alt="APIDoc">
    </a>
    <a href="https://travis-ci.org/Kitura-Next/Kitura-Session">
    <img src="https://travis-ci.org/Kitura-Next/Kitura-Session.svg?branch=master" alt="Build Status - Master">
    </a>
...
Add the `Kitura-Session` package to the dependencies within your application’s `Package.swift` file. Substitute `"x.x.x"` with the latest `Kitura-Session` [release](https://github.com/Kitura-Next/Kitura-Session/releases).

```swift
.package(url: "https://github.com/Kitura-Next/Kitura-Session.git", from: "x.x.x")
```
...
In this example, an instance of `RedisStore` is created that will be used to persist session data (see [`KituraSessionRedis`](https://github.com/Kitura-Next/Kitura-Session-Redis) for more information).  An instance of `Session` is then created, specifying *redisStore* as the session store.  Finally, the *session* instance is registered as middleware on the desired path.
...
* [Redis store](https://github.com/Kitura-Next/Kitura-Session-Redis)
* [SQL store using Kuery](https://github.com/krzyzanowskim/Kitura-Session-Kuery) (community authored)

## API Documentation
For more information visit our [API reference](https://kitura-next.github.io/Kitura-Session/index.html).
